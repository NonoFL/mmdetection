...
class MyFPNv12_1_10(BaseModule):
    ...
    def __init__(self,
        ...
        super(MyFPNv12_1_10, self).__init__(init_cfg)
...
class BasicRFB(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride=1, scale = 0.1, visual = 1):
        ...
        self.branch01 = nn.Sequential(
                ...
                BasicConv(in_planes, 4*inter_planes, kernel_size=3, stride=1, padding=visual, dilation=visual, relu=False)
        )
