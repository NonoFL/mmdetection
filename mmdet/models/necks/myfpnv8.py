...
class MyFPNv8(BaseModule):
    ...
    def __init__(self,
        ...
        super(MyFPNv8, self).__init__(init_cfg)
...
class BasicRFB(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride=1, scale = 0.1, visual = 1):
        ...
        self.branch2 = nn.Sequential(
                ...
                BasicConv(inter_planes, 2*inter_planes, kernel_size=3, stride=1, padding=2*visual+1, dilation=2*visual+1, relu=False)
                )
